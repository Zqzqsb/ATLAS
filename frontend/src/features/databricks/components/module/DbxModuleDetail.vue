...
import MetricViewDetail from './modules/MetricViewDetail.vue'
import AgentMetadataDetail from './modules/AgentMetadataDetail.vue'
import GenieDetail from './modules/GenieDetail.vue'
import UcFedDetail from './modules/UcFedDetail.vue'
import PolicyDetail from './modules/PolicyDetail.vue'
import MvMaterializeDetail from './modules/MvMaterializeDetail.vue'

const props = defineProps<{ flow: DbxFlowDef }>()
...
const REGISTRY: Record<string, Component> = {
  'metric-view': MetricViewDetail,
  'agent-metadata': AgentMetadataDetail,
  genie: GenieDetail,
  'uc-federation': UcFedDetail,
  'policy-runtime': PolicyDetail,
  'mv-materialize': MvMaterializeDetail,
}
