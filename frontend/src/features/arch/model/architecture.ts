...
export const ARCH_LAYERS: ArchLayer[] = [
  ...
  },
  {
    ...
    cols: 4,
    nodes: [
      { id: 'rc-schema', label: 'Schema Metadata', sublabel: 'rc_tables / rc_columns / rc_relations', icon: 'i-lucide-table-2', accent: 'indigo', span: 1 },
      { id: 'rc-context', label: 'Rich Context', sublabel: 'rc_business_context', icon: 'i-lucide-book-text', accent: 'indigo', span: 1 },
      { id: 'rc-embed', label: 'Vector Embeddings', sublabel: 'rc_embeddings · VECTOR(2048)', icon: 'i-lucide-radar', accent: 'indigo', span: 1 },
      { id: 'rc-log', label: 'Change Log', sublabel: 'rc_change_log', icon: 'i-lucide-scroll-text', accent: 'indigo', span: 1 },
    ],
  },
  {
    id: 'foundation',
