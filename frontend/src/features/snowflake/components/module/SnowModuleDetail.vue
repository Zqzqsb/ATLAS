...
import SemanticViewDetail from './modules/SemanticViewDetail.vue'
import AnalystFlowDetail from './modules/AnalystFlowDetail.vue'
import VqrDetail from './modules/VqrDetail.vue'
import CortexSearchDetail from './modules/CortexSearchDetail.vue'
import AutopilotDetail from './modules/AutopilotDetail.vue'
import PolicyDetail from './modules/PolicyDetail.vue'

const props = defineProps<{ flow: SnowFlowDef }>()
...
const REGISTRY: Record<string, Component> = {
  'semantic-view': SemanticViewDetail,
  'analyst-flow': AnalystFlowDetail,
  vqr: VqrDetail,
  'cortex-search': CortexSearchDetail,
