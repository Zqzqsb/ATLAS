...
import IngestDetail from './modules/IngestDetail.vue'
import SearchDetail from './modules/SearchDetail.vue'
import McpDetail from './modules/McpDetail.vue'
import SemanticLayerDetail from './modules/SemanticLayerDetail.vue'
import MemoryDetail from './modules/MemoryDetail.vue'
import DaemonDetail from './modules/DaemonDetail.vue'
import StorageDetail from './modules/StorageDetail.vue'

const props = defineProps<{ flow: KtxFlowDef }>()
