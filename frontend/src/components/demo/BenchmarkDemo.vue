  ...
  <div class="space-y-6">
    ...
    <div class="card p-6">
      ...
      <p class="text-gray-600 text-sm">
        Run Text-to-SQL queries on Spider datasets to see the complete inference process.
      </p>
    </div>
    ...
    <div class="card p-6">
      <div class="mb-4">
        <label class="block text-sm font-medium text-gray-700 mb-2">Natural Language Question</label>
        <textarea
          v-model="store.question"
          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
          rows="3"
          placeholder="e.g. Find all employees' names and departments"
        />
      </div>
